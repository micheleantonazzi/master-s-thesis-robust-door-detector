...
PRETRAINED_FINETUNE_ALL_LR_LOW_NOSTEP_AUG_10OBJQUERIES_LABELLED: DESCRIPTION = 16
PRETRAINED_FINETUNE_ALL_LR_LOW_STEP20_AUG_10OBJQUERIES_LABELLED: DESCRIPTION = 17
PRETRAINED_FINETUNE_ALL_LR_LOW_NOSTEP_NOAUG_10OBJQUERIES_MYDATASETLABELLED: DESCRIPTION = 18
PRETRAINED_FINETUNE_ALL_LR_LOW_NOSTEP_AUG_10OBJQUERIES_FINALDATASET: DESCRIPTION = 19
PRETRAINED_FINETUNE_ALL_LR_LOW_NOSTEP_AUG_10OBJQUERIES_FIRST_LABELLED_FINETUNE_GIBSONSMALL: DESCRIPTION = 20
PRETRAINED_FINETUNE_ALL_LR_LOW_NOSTEP_AUG_10OBJQUERIES_MYDATASETLABELLED: DESCRIPTION = 21
...
class DetrDoorDetector(nn.Module):
    ...
    def set_dataset_name(self, dataset_name: DATASET):
        self._dataset_name = dataset_name
