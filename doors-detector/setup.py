...
__version__ = find_version("doors_detector", "__version__.py")
...
setup(
    name='doors-detector',
    version=__version__,
    description="Doors detector",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/micheleantonazzi/master-thesis-robust-door-detector",
